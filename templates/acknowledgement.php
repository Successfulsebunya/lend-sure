...
<div class="title">
    ...
    <div class="sub">
        <?php /* translators: %d: numeric loan ID. */ ?>
        <?php echo esc_html( sprintf( __( 'Loan Reference: LS-%06d', 'lend-sure' ), $loan->id ) ); ?>
    </div>
</div>
...
<tr><td><?php esc_html_e( 'Agreed late-payment penalty', 'lend-sure' ); ?></td><td><?php echo esc_html( $lendsure_penalty_label ); ?></td></tr>
...
<ul class="terms-list">
    <li>
        <?php /* translators: %s: monthly interest rate percentage. */ ?>
        <?php echo esc_html( sprintf( __( 'Interest is charged at %s%% per month.', 'lend-sure' ), number_format_i18n( $loan->interest_rate, 2 ) ) ); ?>
    </li>
    <li>
        <?php /* translators: %s: agreed late-payment penalty description. */ ?>
        <?php echo esc_html( sprintf( __( 'The agreed late-payment penalty is %s.', 'lend-sure' ), $lendsure_penalty_label ) ); ?>
    </li>
...
<div><div class="line"><?php esc_html_e( 'Lender / Authorized Signatory', 'lend-sure' ); ?></div><p><?php esc_html_e( 'Date:', 'lend-sure' ); ?> __________________</p></div>
<div><div class="line"><?php esc_html_e( 'Witness 1 Name & Signature', 'lend-sure' ); ?></div><p><?php esc_html_e( 'Phone / ID:', 'lend-sure' ); ?> __________________</p></div>
<div><div class="line"><?php esc_html_e( 'Witness 2 Name & Signature', 'lend-sure' ); ?></div><p><?php esc_html_e( 'Phone / ID:', 'lend-sure' ); ?> __________________</p></div>
</div>
